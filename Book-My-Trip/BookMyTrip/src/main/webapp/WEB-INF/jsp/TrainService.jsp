...
<div class="card shadow mb-5 bg-white rounded mt-3">
	...
	<div class="card-body">
		...
		<!--Card-Title-->
		<p class="card-title text-center shadow mb-5 rounded">Train Booking Form</p>

    <div class="icons text-center">
        <a href="trains"><i class="fa fa-train fa-3x" aria-hidden="true"></i></a>
    </div>

    <hr>

	<p class="searchText"><strong>Search For Trains</strong></p>
	...
	<div class="row">
        ...
        <div class="col-sm-6">
            ...
            <option value="" disabled="" selected="">From City/Station</option>
        ...
        <div class="col-sm-6">
            ...
            <option value="" disabled="" selected="" >To City/Station</option>
            <option value="new delhi">New Delhi</option>
            <option value="mumbai">Mumbai</option>
            <option value="bangalore">Bangalore</option>
            <option value="kolkata">Kokata</option>
	...
	<div class="row">
	    ...
	    <button class="btn btn-primary float-right mt-5">Find Trains</button>

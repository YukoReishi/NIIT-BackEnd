    ...
    <nav class="navbar navbar-inverse" style="padding-top: 5px;font-size: 16px;">
        <div class="container-fluid">
          <div class="navbar-header">
            <a class="navbar-brand" href="landingPage">FoodDeliverySystem</a>
          </div>
        ...
        <div class="col justify-content-center align-items-center text-center">
          <div class="text-white">
            <h1 class="mb-3" style="margin-top:15%; font-weight: bolder;">Welcome to Book My Trip Application</h1>
            <h4 class="mb-4" style="font-weight: bold;">Travel safe Journey</h4>
            </div>
            </div>
